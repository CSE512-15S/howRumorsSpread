...
retweets = db.lakemba.find({retweeted_status: {$exists: true}}, { 'created_ts': 1, 'user.followers_count': 1, 'user.verified': 1, 'user.screen_name': 1, 'retweeted_status.id': 1 }).toArray();
